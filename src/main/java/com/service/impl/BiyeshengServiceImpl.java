...
public class BiyeshengServiceImpl extends ServiceImpl<BiyeshengDao, BiyeshengEntity> implements BiyeshengService {
    ...
    @Override
    public List<Map<String, Object>> selectValue(Map<String, Object> params, Wrapper<BiyeshengEntity> wrapper) {
        return baseMapper.selectValue(params, wrapper);
    }

    @Override
    public List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params, Wrapper<BiyeshengEntity> wrapper) {
        return baseMapper.selectTimeStatValue(params, wrapper);
    }

    @Override
    public List<Map<String, Object>> selectGroup(Map<String, Object> params, Wrapper<BiyeshengEntity> wrapper) {
        return baseMapper.selectGroup(params, wrapper);
    }

    @Override
    public List<Map<String, Object>> yuanxijiuyezhuangtaiTypeStat(Map<String, Object> params, Wrapper<BiyeshengEntity> wrapper) {
        return baseMapper.yuanxijiuyezhuangtaiTypeStat(params, wrapper);
    }
